...
*/
//======================= SUICIDE ====================================================
action_ShootYourself = _role addaction ["Shoot yourself","T@Wsuicide.sqf", [""],  0.5, false, true,"", '_in_hands = (call holster_pistol_in_hands); _in_inv = (call holster_pistol_in_inventory); _in_inv && not(_in_hands) && isCiv'];
//=======================   Road Gates ==============================================
/*
